    ...
    <div >
        ...
        <div className="flex flex-col space-y-8 pb-10 pt-12 px-2 md:pt-24">
          ...
          <p className=" text-center font-heading_font text-3xl  text-[#27374D] dark:text-[#DDE6ED] md:text-5xl md:leading-10">
            Unveiling Knowledge: Dive Into Our Blog
          </p>
          <p className="max-w-4xl mx-auto text-center text-base font-body_font   text-gray-600 md:text-xl">
          Whether it's football, basketball, cricket, or tennis, these blog page covers a wide range of sports, ensuring there's something for every sports fan to enjoy.
          </p>
          <div className="mt-6 mx-auto flex w-full items-center space-x-2 md:w-1/3">
            ...
            <button
              type="button"
              className="rounded-md bg-black dark:bg-gray-700 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
            >
              Search
            </button>
          </div>
          ...
          {posts.map((post) => (
            <div key={post._id} className=" border cursor-pointer  dark:glass-container bg-gray-100 dark:bg-[#131315] rounded-lg shadow-md">
              ...
              <div className="min-h-min p-3">
                ...
                <p className="mt-4 flex-1 text-xl font-semibold  text-[#27374D] dark:text-[#DDE6ED]">{post.title.slice(0, 32 )}{"...."}</p>
                  <p className=" text-gray-600 w-full text-sm leading-normal ">
                <p dangerouslySetInnerHTML={{ __html: `${post.content.slice(0, 90)}...` }} />
                </p>
                <div className="mt-4 flex space-x-3 ">
                  <img className="h-full w-10 rounded-lg" src={post.adminImage} />
                  <div>
                    <p className="text-sm font-heading_font text-[#27374D] dark:text-[#DDE6ED]  leading-tight mb-1">
                      {post.adminName}
                    </p>
                    <p className="text-sm leading-tight text-gray-600">{new Date(
                                    post.updatedAt
        ...
        <div className="w-full border-t border-gray-300">
          <div className="mt-2 flex items-center justify-between">
            <div className="hidden md:block text-gray-700">
              <p>
                showing <strong>1</strong> to <strong>6</strong> of <strong>{fullPost.totalPost}</strong> results
              </p>
            </div>
